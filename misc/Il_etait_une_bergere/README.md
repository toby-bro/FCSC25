...
The assembly cone has ene purposeeds to doating the square root of a number.

The algorithm I implemented is that of "[Hero of Alexandria](https://en.wikipedia.org/wiki/Hero_of_Alexandria)", which is a super method to calculate really precise approximations of square roots by hand. In three steps the precision is really impressive for such an old algorithm.
